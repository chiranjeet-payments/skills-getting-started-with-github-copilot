                ...
                .map(
                  (participant) => `
                    <li>
                      ...
                      <button class="remove-participant" type="button" data-activity="${name}" data-participant="${participant}" aria-label="Unregister ${participant}" title="Unregister participant">&times;</button>
                    </li>`
                )
                .join("")}
            </ul>
